...
public class ExtractSingleFile {
    ...
    public ExtractSingleFile() throws ZipException, IOException {
        ...
        UnzipIt unzip = UnzipIt.builder().zipFile(Paths.get("c:\\ZipTest\\ExtractSingleFile.zip")).build();
...
//        }
        ...
        unzip.extract(Paths.get("c:\\ZipTest\\"), "Ronan_Keating_-_In_This_Life.mp3");
        ...
        unzip.extract(Paths.get("c:\\ZipTest\\"), "FolderToAdd\\myvideo.avi");
    }
