 ...
 */
@Test
public class InfoZipOldUnixExtraFieldViewTest {
    ...
    public void shouldRetrieveAllDataWhenAllDataSet() throws IOException {
        ...
        InfoZipOldUnixExtraField record = InfoZipOldUnixExtraField.builder()
                                                                  .dataSize(8)
        ...
        String[] lines = Zip4jvmSuite.execute(InfoZipOldUnixExtraFieldView.builder()
                                                                          .record(record)
                                                                          .block(block)
    ...
    public void shouldRetrieveEmptyStringWhenRecordNull() throws IOException {
        String[] lines = Zip4jvmSuite.execute(InfoZipOldUnixExtraFieldView.builder()
                                                                          .record(InfoZipOldUnixExtraField.NULL)
