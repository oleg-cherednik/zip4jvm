...
public class UnzipItPath {
    ...
    /**
     * Destination directory for extracted files; by default its directory where given `zip` archive is located
     */
    private Path dstDir;
    /**
     * Settings for unzip files
     */
     ...
     */
    public static UnzipItPath create(Path zip) {
        requireNotNull(zip, "UnzipPath.zip");
        return new UnzipItPath(SrcZip.of(zip)).dstDir(zip.getParent());
    }
     ...
     * @return not {@literal null} {@link UnzipItPath} instance
     */
    public UnzipItPath dstDir(Path dstDir) {
        requireNotNull(dstDir, "UnzipPath.dstDir");
        requireDirectory(dstDir, "UnzipPath.dstDir");
     ...
     * @return not {@literal null} {@link UnzipItPath} instance
     */
    public UnzipItPath settings(UnzipSettings settings) {
    ...
    public void extract(String fileName) throws IncorrectPasswordException {
        requireNotBlank(fileName, "UnzipPath.fileName");
    ...
    public void extract(Collection<String> fileNames) throws IncorrectPasswordException {
        requireNotNull(fileNames, "UnzipPath.fileNames");
