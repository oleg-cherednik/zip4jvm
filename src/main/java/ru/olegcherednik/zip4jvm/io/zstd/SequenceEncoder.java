...
import static ru.olegcherednik.zip4jvm.io.zstd.Constants.MAX_OFFSET_CODE_SYMBOL;
...
public class SequenceEncoder {
    ...
    private static final FseCompressionTable DEFAULT_LITERAL_LENGTHS_TABLE = FseCompressionTable.newInstance(DEFAULT_LITERAL_LENGTH_NORMALIZED_COUNTS,
            MAX_LITERALS_LENGTH_SYMBOL, DEFAULT_LITERAL_LENGTH_NORMALIZED_COUNTS_LOG);
    private static final FseCompressionTable DEFAULT_MATCH_LENGTHS_TABLE = FseCompressionTable.newInstance(DEFAULT_MATCH_LENGTH_NORMALIZED_COUNTS,
            MAX_MATCH_LENGTH_SYMBOL, DEFAULT_LITERAL_LENGTH_NORMALIZED_COUNTS_LOG);
    private static final FseCompressionTable DEFAULT_OFFSETS_TABLE = FseCompressionTable.newInstance(DEFAULT_OFFSET_NORMALIZED_COUNTS,
            DEFAULT_MAX_OFFSET_CODE_SYMBOL, DEFAULT_OFFSET_NORMALIZED_COUNTS_LOG);
    ...
    public static int compressSequences(byte[] outputBase, final int outputAddress, int outputSize, SequenceStore sequences,
        ...
        int literalsLengthEncodingType = selectEncodingType(largestCount, sequenceCount, DEFAULT_LITERAL_LENGTH_NORMALIZED_COUNTS_LOG, true,
                strategy);
        ...
        // flags
        UnsafeUtil.putByte(outputBase, headerAddress,
    ...
    private static int buildCompressionTable(FseCompressionTable table, byte[] outputBase, int output, long outputLimit, int sequenceCount,
        ...
        return FiniteStateEntropy.writeNormalizedCounts(outputBase, output, (int)(outputLimit - output), normalizedCounts, maxSymbol,
