 ...
 * @since 25.10.2019
 */
final class ExtendedTimestampExtraFieldRecordReader implements ReaderWithSize<ExtendedTimestampExtraFieldRecord> {

    @Override
    public ExtendedTimestampExtraFieldRecord read(DataInput in, int size) {
