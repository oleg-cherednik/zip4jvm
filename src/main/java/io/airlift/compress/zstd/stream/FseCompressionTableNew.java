...
public class FseCompressionTableNew
{
    ...
    public FseCompressionTableNew(int maxTableLog, int maxSymbol)
    {
    ...
    public static FseCompressionTableNew newInstance(short[] normalizedCounts, int maxSymbol, int tableLog)
    {
        FseCompressionTableNew result = new FseCompressionTableNew(tableLog, maxSymbol);
    ...
    public int encode(BitOutputStreamNew stream, int state, int symbol)
    {
    ...
    public void finish(BitOutputStreamNew stream, int state)
    {
